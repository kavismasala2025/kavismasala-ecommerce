...
const NAV = [
  ...
  {
    label: 'Products',
    to: '/myportal/products',
    icon: Package,
  },
  {
    label: 'Categories',
    to: '/myportal/categories',
    icon: Tags,
  },
  {
    label: 'Customers',
    to: '/myportal/customers',
    icon: Users,
  },
  {
    label: 'Inventory',
    to: '/myportal/inventory',
    icon: Boxes,
  },
  {
    label: 'Coupons',
  ...
  {
    label: 'Analytics',
    to: '/myportal/analytics',
    icon: BarChart3,
  },
  {
    label: 'Settings',
    to: '/myportal/settings',
    icon: Settings,
  },
];
  ...
  return (
    <div className="min-h-screen bg-stone-100 flex">
      ...
      <aside
        ...
        bg-maroon-900 text-white/80 flex flex-col
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        {/* MOBILE HEADER */}
        <header
          className="lg:hidden bg-maroon-800 border-b border-white/10
