  ...
  return (
    <input
      ...
      className={`w-full px-3 py-3 rounded-xl border text-sm
        focus:outline-none
        focus:ring-2 focus:ring-maroon-200
        ...
        ${
          error
            ...
            : readOnly
              ...
              : 'border-stone-200 bg-white focus:border-maroon-500'
        }`}
    />
  );
}
...
function SummaryCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-stone-100 p-4 sm:p-5">
      <h2 className="font-bold text-stone-900 text-base sm:text-lg mb-3">
        Order Summary
      </h2>
        ...
        {items.map((l) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="text-xs sm:text-sm font-medium text-stone-900 line-clamp-2 leading-tight">
                {l.product.name}
              </div>

              <div className="text-xs text-stone-500 mt-0.5">
                Qty {l.quantity} · {formatINR(l.product.price)}
              </div>
            </div>
      ...
      <div className="mt-3 bg-stone-50 rounded-xl p-2.5 text-xs text-stone-500">
        ...
        <strong className="text-stone-700">
          {waNumber || 'your WhatsApp'}
        </strong>{' '}
        for payment and dispatch updates.
      </div>
    </div>
  );
}
...
export default function Checkout() {
  ...
  const [step, setStep] = useState<'details' | 'processing'>(
    'details'
  );
  ...
  const totalWeightGrams = items.reduce(
    (sum, item) => {
      const weight =
        item.product.weight?.toLowerCase().trim() ?? '';
  ...
  useEffect(() => {
    ...
    try {
      const raw =
        localStorage.getItem(SAVED_CUSTOMER_KEY);

      if (raw) {
        const saved =
          JSON.parse(raw) as Partial<SavedCustomer>;
  ...
  const set = <K extends keyof SavedCustomer>(
    key: K,
    val: SavedCustomer[K]
  ) => {
    setForm((f) => ({
  ...
  const validate = () => {
    ...
    if (
      ...
      e.phone2 =
        'Enter a valid 10-digit number or leave blank';
    }

    if (
      !form.whatsAppSameAsPhone1 &&
      !/^\d{10}$/.test(
        form.whatsappNumber.replace(/\D/g, '')
      )
    ) {
      e.whatsappNumber =
    ...
    try {
      ...
      const {
        ...
        .insert({
          ...
          phone2:
            form.phone2.trim() || null,
          whatsapp_number:
            effectiveWhatsApp.trim() || null,
          address: fullAddress,
          city: form.city.trim(),
      ...
      <div className="bg-cream-50 min-h-[70vh] flex items-center justify-center px-4">
        <div className="text-center py-16 max-w-xs mx-auto">
          ...
          <button
            ...
            className="mt-5 text-maroon-700 font-semibold hover:underline"
          >
            Go to shop
          </button>
        </div>
        ...
        {step === 'details' && (
          <div className="grid gap-4 sm:gap-6 lg:grid-cols-3">
            ...
            <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1">
              ...
              <form
                onSubmit={placeOrder}
                className="bg-white rounded-2xl border border-stone-100 p-4 sm:p-6 space-y-5 sm:space-y-6"
              >
                  ...
                  savedAddresses.length >
                    ...
                    <section className="bg-cream-50/60 border border-cream-200 rounded-xl p-3 sm:p-4">
                      ...
                      <div className="flex items-center justify-between mb-2 flex-wrap gap-2">
                        ...
                        <Link
                          to="/account/profile"
                          className="text-xs text-maroon-700 font-semibold hover:underline"
                        >
                          Manage
                        </Link>
                      </div>
                          ...
                          (a) => {
                            ...
                            return (
                              <button
                                ...
                                className={`text-left p-3 rounded-lg border-2 transition-all duration-150 active:scale-[0.97] hover:shadow-md ${
                                  selected
                              ...
                              >
                                ...
                                <div className="flex items-center justify-between gap-2">
                                  ...
                                  {selected && (
                                    <Check className="w-4 h-4 text-maroon-700 ml-auto" />
                                  )}
                                </div>
                ...
                <section>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 mb-3 sm:mb-4">
                    ...
                    <h2 className="font-bold text-stone-900 text-base sm:text-lg flex items-center gap-2">
                      <User className="w-5 h-5 text-maroon-700 shrink-0" />
                      Your details
                    </h2>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        <svg
                          viewBox="0 0 24 24"
                          className={`absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 fill-current ${
                            form.whatsAppSameAsPhone1
                              ? 'text-stone-300'
                              : 'text-green-500'
                          }`}
                      ...
                      {!errors.whatsappNumber && (
                        <p className="text-xs text-stone-400 mt-1">
                          Order updates will be
                          sent to this WhatsApp
                          number
                        </p>
                      )}
                    </Field>
                ...
                <section>
                  ...
                  <h3 className="font-bold text-stone-900 text-base sm:text-lg flex items-center gap-2 mb-3 sm:mb-4">
                    <MapPin className="w-5 h-5 text-maroon-700 shrink-0" />
                    Delivery address
                  </h3>
                ...
                <section>
                  ...
                  <h3 className="font-bold text-stone-900 text-base sm:text-lg flex items-center gap-2 mb-3">
                    <Package className="w-5 h-5 text-maroon-700 shrink-0" />
                    Courier charge
                  </h3>
                      ...
                      (loc) => {
                        ...
                        return (
                          <button
                            ...
                            className={`flex flex-col text-left p-3 rounded-xl border-2 transition-all duration-150 active:scale-[0.97] hover:shadow-md ${
                              form.deliveryLocation ===
                              loc
                          ...
                          >
                            ...
                            <span className="text-xs text-maroon-700 font-bold mt-1">
                              {formatINR(
                                info.rate
                              )}
                            </span>
                ...
                <div className="pt-1">
                  ...
                  <button
                    type="submit"
                    className="w-full inline-flex items-center justify-center gap-2 bg-maroon-800 hover:bg-maroon-900 active:bg-maroon-950 active:scale-[0.98] hover:shadow-lg text-white font-bold px-6 py-4 rounded-full transition-all duration-150 text-base shadow-md"
                  >
